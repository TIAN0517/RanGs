...
void CMobSetPage::OnBnClickedButtonCsvExport()
{
	...
	while ( pCur )
	{
		...
		streamFILE << pCur->Data->m_pAffineParts->vTrans.x << ",";
		streamFILE << pCur->Data->m_pAffineParts->vTrans.y << ",";
		streamFILE << pCur->Data->m_pAffineParts->vTrans.z << ",";

		streamFILE << pCur->Data->m_pAffineParts->vScale.x << ",";
		streamFILE << pCur->Data->m_pAffineParts->vScale.y << ",";
		streamFILE << pCur->Data->m_pAffineParts->vScale.z << ",";

		streamFILE << pCur->Data->m_pAffineParts->vRotate.x << ",";
		streamFILE << pCur->Data->m_pAffineParts->vRotate.y << ",";
		streamFILE << pCur->Data->m_pAffineParts->vRotate.z << ",";
