...
void GLFriendClient::MsgReqFriendAddLure ( NET_MSG_GENERIC* nmg )
{
	...
	//m_pGaeaClient->GetInterface()->DOMODAL_ADD_FRIEND_REQ(pNetMsg->szREQ_CHAR);

	NotifyFactory factory;

	std::string strCombine = sc::string::format( ID2GAMEINTEXT("ADD_FRIEND_REQ"), pNetMsg->szREQ_CHAR );	
