...
void GLGaeaClient::MsgClubCD_CertifyFB(NET_MSG_GENERIC* nmg)
{
    ...
    case EMCDCERTIFY_OK:
		...
		//!! SF_TODO
        GetInterface()->SET_CONFT_CONFIRM_VISIBLE(true);
        break;
    ...
    case EMCDCERTIFY_ING_TIMEOUT:
		...
		//!! SF_TODO
        GetInterface()->SET_CONFT_CONFIRM_VISIBLE(false);
        break;
...
void GLGaeaClient::MsgClubId2MasterNameAnsAC(NET_MSG_GENERIC* pMsg)
{
	...
	GetInterface()->SetClubMasterClubName(RecvData.m_vecMasterName, RecvData.m_vecClubName);
