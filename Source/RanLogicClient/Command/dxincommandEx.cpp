...
bool GameCommand::ChatLog(splitVector& SplitVec)
{
    ...
    if ( strPARAM_01=="on" )
    {
		...
		m_pGaeaClient->GetInterface()->ChatLog( true, (DWORD) nChatLogType );
...
bool GameCommand::Hack(splitVector& SplitVec)
{
    try
    {
		...
		else if ( SplitVec[1] == "streak" )
		{
			//m_pGaeaClient->GetInterface()->SET_PKCOMBO( atoi(SplitVec[2].c_str()) );

			if ( atoi(SplitVec[2].c_str()) == 1 )		{	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_FIRST" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 0 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 2 )	{	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_DOUBLE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 1 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 3 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_TRIPLE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 2 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 4 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_ULTRA" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 3 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 5 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_RAMPAGE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 4 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 6 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_KILLING_SPREE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 5 ); } 
			else if ( atoi(SplitVec[2].c_str()) == 7 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_DOMINATING" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 6 );	 }
			else if ( atoi(SplitVec[2].c_str()) == 8 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_MEGA_KILL" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 7 );	 }
			else if ( atoi(SplitVec[2].c_str()) == 9 ) {	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_UNSTOPPABLE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 8 );	 }
			else if ( atoi(SplitVec[2].c_str()) == 10 ){	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_WICKED_SICK" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 9 );	 }
			else if ( atoi(SplitVec[2].c_str()) == 11 ){	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_MONSTER_KILL" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 10 ); }
			else if ( atoi(SplitVec[2].c_str()) == 12 ){	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_GODLIKE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 11 );		 }
			else if ( atoi(SplitVec[2].c_str()) == 13 ){	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_HOLY_SHIT" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 12 );	 }
			else if ( atoi(SplitVec[2].c_str()) >= 14 ){	DxSoundLib::GetInstance()->PlaySound ( "PKCOMBO_OWNAGE" ); m_pGaeaClient->GetInterface()->SET_PKCOMBO( 13 );		 }

			if ( atoi(SplitVec[2].c_str()) > 3 )
			{
				CString PKStreak[15] =
				{
					"",
				...
				int nIndex = atoi(SplitVec[2].c_str()) - 1;
				if ( nIndex > 14 ) nIndex = 14;

				m_pGaeaClient->GetInterface()->ProgressDisplayShowPulblic ( PKStreak[nIndex].GetString(), ITEM_INFOR_COLOR::dwAddAbility );

				m_pGaeaClient->PrintConsoleText (PKStreak[nIndex].GetString());

				const D3DXVECTOR3& vPosition = m_pGaeaClient->GetCharacter()->GetPosition();
				D3DXMATRIX matTrans;
				STARGETID sTarget( CROW_PC, m_pGaeaClient->GetCharacter()->GetGaeaID() );
			...
			m_pGaeaClient->GetCharacter()->m_PKStreakData.DoIncrease(atoi(SplitVec[2].c_str()));
		}
		else if ( SplitVec[1] == "duel" )
		{
			m_pGaeaClient->GetInterface()->SetFightBegin( 0 );
		}
		...
		case 2:
			{
				...
				{
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->SetIndicatorTime(60,true,true);
					return true;
				}
				else if ( _command == "Indicator" )
				{
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->UiShowGroupFocus(COMPETITION_TOURNAMENTENT_INDICATOR);
					return true;
				}
				else if ( _command == "multy" )
				{
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->UiShowGroupFocus(COMPETITION_TOURNAMENT_MULTY);
					return true;
				}
				else if ( _command == "countPacket" )
				{
		...
		case 3:
			{
				...
				{ 
					...
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->SetBigGroupWindowLeft(factionid);
					return true;
				}
				else if ( _command == "BigRight" )
				{
					unsigned int factionid = boost::lexical_cast<unsigned int>(_param);
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->SetBigGroupWindowRight(factionid);
					return true;
				}
				...
				{ 
					unsigned int factionid = boost::lexical_cast<unsigned int>(_param);
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->SetMiniGroupWindowLeft(factionid);
					return true;
				}
				else if ( _command == "MiniRight" )
				{
					unsigned int factionid = boost::lexical_cast<unsigned int>(_param);
					//!! SF_TODO
					m_pGaeaClient->GetInterface()->SetMiniGroupWindowRight(factionid);
					return true;
				}
