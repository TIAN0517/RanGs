    ...
    case EMPET_USECARD_FB_OK:
        {
            ...
            {						
               ...
               // GetInterface()->SetPetHungryItem( pItem->GetNativeID() );
				//!! SF_TODO
                //GetInterface()->SetPetHungryItem( m_pCharacter->m_sPetCardNativeID );
                //GetInterface()->SetPetHungry();
                //GetInterface()->UiShowGroupBottom( PET_HUNGRY );
            }
