...
namespace TexasHoldem
{
	...
	void GLTexasHoldemClient::FrameMove( float fElapsedTime )
	{
		...
		//!! SF_TODO
		if ( m_pGaeaClient->GetInterface()->IsVisible( MINIGAME_TEXASHOLDEM_WINDOW ) )
		{
	...
	void GLTexasHoldemClient::MsgChipMapEnd( NET_MSG_GENERIC* pMessage )
	{
		...
		if ( false == nmg->bFirst )
		{
			...
			//!! SF_TODO
			m_pGaeaClient->GetInterface()->OpenTexasHoldemWindow();
		}
	}
	...
	void GLTexasHoldemClient::MsgCloseMainMenu( NET_MSG_GENERIC* pMessage )
	{
		...
		m_pGaeaClient->GetInterface()->CloseTexasHoldemWindow();
	}
	...
	void GLTexasHoldemClient::MsgStartGameFB( NET_MSG_GENERIC* pMessage )
	{
		...
		m_pGaeaClient->GetInterface()->SetTexasHoldemURL( strURL, strPOST );
		m_pGaeaClient->GetInterface()->RunTexasHoldemWindow();
	}
	...
	void GLTexasHoldemClient::MsgEndGameFB( NET_MSG_GENERIC* pMessage )
	{
		...
		m_pGaeaClient->GetInterface()->StopTexasHoldemWindow();
	...
	void GLTexasHoldemClient::Offline()
	{
		...
		//!! SF_TODO
		if( m_pGaeaClient->GetInterface()->UiIsVisibleGroup( MINIGAME_TEXASHOLDEM_WEB_WINDOW ) == FALSE )
			return;
	...
	void GLTexasHoldemClient::RequestInvenDrugCardGameCard(WORD PosX, WORD PosY)
	{
		...
		//!! SF_TODO
		if ( m_pGaeaClient->GetInterface()->UiIsVisibleGroup( MINIGAME_TEXASHOLDEM_WINDOW ) )
			return;
