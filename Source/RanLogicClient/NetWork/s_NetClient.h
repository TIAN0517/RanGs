...
public:
	...
	*/
	...
	int SndRegister(const TCHAR* szUserID, const TCHAR* szUserPassword, const TCHAR* szUserPass2, const TCHAR* szUserEmail, const TCHAR* szRandomPassword, int nChannel=0);
