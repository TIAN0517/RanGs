...
void GLCharacter::MsgQuestionItemFactBrd(NET_MSG_GENERIC* pMsg)
{
	...
	m_pGaeaClient->GetInterface()->SET_QUESTION_ITEM_ID( pNetMsg->sFACT.emType );
    ...
    case QUESTION_ATTACK_UP_M:
		...
		m_pGaeaClient->GetInterface()->SET_KEEP_QUESTION_ITEM_ID ( pNetMsg->sFACT.emType );
        break;
...
void GLCharacter::MsgQuestionItemFactEndBrd(NET_MSG_GENERIC* pMsg)
{
	...
	m_pGaeaClient->GetInterface()->RESET_KEEP_QUESTION_ITEM();
}