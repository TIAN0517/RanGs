...
namespace PVP
{
	...
	public: 
		...
		struct CTFPREVSTATE
		{
			...
			VEC_CTF_RANKER		vecRESULTDATACLUB;   // 결과 정보
	...
	public:
		...
		void				AddResultDataClub( const SCTFRESULTDATA& sData );
		...
		VEC_RESULTDATA&		GetResultDataClub() { return m_vecResultDataClub; }
		SCTFRESULTDATA&		GetMyResultData() { return m_MyResultData; }
		SCTFRESULTDATA&		GetMyResultDataClub() { return m_MyClubResultData; }
		const UINT		    GetMyResultRanking() { return m_MyResultRanking; }
		const UINT		    GetMyResultRankingSchool() { return m_MyResultRankingSchool; }
		const UINT		    GetMyResultRankingClub() { return m_MyResultRankingClub; }
