...
public:  
    ...
    //! ProgressDisplay
    virtual void ProgressDisplayShow ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor = NS_UITEXTUTIL::WHITE ) = 0;

    //! Point Shop Window
    virtual void ReloadPointShopItemList() = 0;
	virtual void PointShopSetBattlePoint( __int64 nCurPoint ) = 0;
