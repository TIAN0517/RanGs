...
void DxGlobalStage::initPacketFunc()
{
	...
	m_GlobalStageMsgFunc[NET_MSG_LOBBY_CHARJOIN_2NDPASS].Msgfunc  = &DxGlobalStage::LobyMsgProcessFrame; // 2瞒厚锅
	m_GlobalStageMsgFunc[NET_MSG_DEFAULT_GAME_OPTION].Msgfunc      = &DxGlobalStage::LobyMsgProcessFrame;
	m_GlobalStageMsgFunc[GS_NET_MSG_WB_LOGIN_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[NET_MSG_REGISTER_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
//userpanel
	m_GlobalStageMsgFunc[CHINA_NET_MSG_PASS_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢 
	m_GlobalStageMsgFunc[CHINA_NET_MSG_PIN_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_EMAIL_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_GT2VP_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_TOPUP_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_PP2VP_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_RESETPASS_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_RESETPASS2_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
	m_GlobalStageMsgFunc[CHINA_NET_MSG_RESETPIN_FB].Msgfunc           = &DxGlobalStage::LobyMsgProcessFrame; // WB 立加咯何 犬牢
...
//     m_GlobalStageMsgFunc[NET_MSG_ACTIVITY_REWARD_BADGE_SYNC].Msgfunc  = &DxGlobalStage::GameMsgProcessFrame;
	...
	m_GlobalStageMsgFunc[NET_MSG_GCTRL_PKCOMBO_BRD].Msgfunc     = &DxGlobalStage::GaeaClientMsgProcessFrame;
	m_GlobalStageMsgFunc[NET_MSG_GCTRL_PKCOMBO_END_BRD].Msgfunc     = &DxGlobalStage::GaeaClientMsgProcessFrame;
	//PK Notification - Arvin.BC
	m_GlobalStageMsgFunc[NET_MSG_PK_RANK_HISTORY_UPDATE].Msgfunc     = &DxGlobalStage::GaeaClientMsgProcessFrame;
