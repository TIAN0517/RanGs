...
#include "./enginelib/GUInterface/ListXML.h"
	...
	, m_bLoginProcessLog(bLoginProcessLog)
{
    ...
    m_pLobyStage = new DxLobyStage(this, m_pGaeaClient, m_pEngineDevice);
...
*/
	...
	for( ; iterXML != listXML.end(); ++iterXML )
	{
		...
		CInterfaceCfg::GetInstance().LoadText( sXMLFILE.strFileName.c_str(), RANPARAM::strCountry, sXMLFILE.bEncrypted );
