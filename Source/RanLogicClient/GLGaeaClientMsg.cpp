...
//  m_GaeaClientMsgFunc[NET_MSG_ACTIVITY_REWARD_BADGE_SYNC].Msgfunc = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MyCharMsgProcess, this);
	...
	m_GaeaClientMsgFunc[NET_MSG_GCTRL_WITH_VEHICLE_TAR].Msgfunc = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MsgGame, this);
	...
	m_GaeaClientMsgFunc[NET_MSG_GCTRL_REQ_STATSUPCMD_FB].Msgfunc = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MyCharMsgProcess, this);
    ...
    m_GaeaClientMsgFunc[NET_MSG_PK_RANK_HISTORY_UPDATE].Msgfunc = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MsgPKNotifBrd, this);

	m_GaeaClientMsgFunc[NET_MSG_REQ_TUTORIAL_ACK].Msgfunc      = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MyCharMsgProcess, this);
	m_GaeaClientMsgFunc[NET_MSG_REQ_CHAR_LOCK_FB].Msgfunc      = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MyCharMsgProcess, this);
	m_GaeaClientMsgFunc[NET_MSG_GCTRL_GET_RANKINGS_FROMDB_FB].Msgfunc      = CLASS_MEMBER_FUNCTION(&GLGaeaClient::MyCharMsgProcess, this);
}
...
// 		GLWidgetScript::GetInstance().LuaCallFunc< void >( NSWIDGET_SCRIPT::g_strFunc_IQS_UpdateSlot );
		...
		GetInterface()->REFRESH_SKILLWINDOW();
