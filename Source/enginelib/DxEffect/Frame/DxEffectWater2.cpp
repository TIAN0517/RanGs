...
const char DxEffectWater2::NAME[] = "[ Water effect 2 ]";
...
HRESULT DxEffectWater2::InitDeviceObjects( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	//TextureManager::LoadTexture ( szSkyTex, pd3dDevice, m_pCubeTexture, 0, 0 );
...
HRESULT DxEffectWater2::CloneData( DxEffectBase* pSrcEffect, LPDIRECT3DDEVICEQ pd3dDevice, DxTextureEffMan* pTexEff )
{
	GASSERT( pSrcEffect );
