...
const char DxEffectWater::NAME[] = "[ Water effect 1 ]";
...
{	
	...
	float fSize = new_max(m_SizeX,m_SizeZ);
...
HRESULT DxEffectWater::CloneData ( DxEffectBase* pSrcEffect, LPDIRECT3DDEVICEQ pd3dDevice, DxTextureEffMan* pTexEff )
{
	GASSERT(pSrcEffect);
