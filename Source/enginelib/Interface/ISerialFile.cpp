...
BOOL ISerialFile::OpenFile(const ic::FOPENTYPE _Type, const char* _szFileName, EMBYTECRYPT emCrypt /*= EMBYTECRYPT_NONE*/ )
{
    FOPENTYPE emType = static_cast<FOPENTYPE>(_Type);
    return SerialFile::OpenFile( emType, _szFileName, emCrypt );
}
