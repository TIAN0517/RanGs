...
#include "../../SigmaCore/File/SFileSystem.h"
#include "../../SigmaCore/File/ByteCrypt.h"
...
SerialMemoryEngine::SerialMemoryEngine(const char *_szZipFileName, const char *_szFileName, EMBYTECRYPT emCrypt /*= EMBYTECRYPT_NONE*/) 
    : sc::SerialMemory(_szZipFileName, _szFileName, emCrypt)
{
}
