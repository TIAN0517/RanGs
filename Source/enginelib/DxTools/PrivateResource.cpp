    ...
    , m_nSize( 0 )
{
	...
	case ETypeSENSEI:
		{
			m_nHeaderSize = SENSEI_SCRIPT_HEADER_SIZE;
			m_nVersion = SENSEI_SCRIPT_VERSION;
			m_nXorValue = SENSEI_SCRIPT_XOR_DATA;
			m_nDiffValue = SENSEI_SCRIPT_DIFF_DATA;
			m_nDiffValue2 = SENSEI_SCRIPT_DIFF2_DATA;
		}
		break;
    }
}
