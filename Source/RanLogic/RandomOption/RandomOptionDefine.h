...
namespace RandomOption
{
	...
	const char cNameValue[RandomOption::RANDOM_OPTION_NSIZE][32] =
	{
		...
		"rate damage", // RANDOM_OPTION_RATE_DAMAGE = 1, // 공격력(비율);
		"rate defense", // RANDOM_OPTION_RATE_DEFENCE = 2,	//	방어력(비율);
		"rate Hitrate", // RANDOM_OPTION_RATE_HIT = 3, // 명중(비율);
		"rate Avoid", // RANDOM_OPTION_RATE_AVOID = 4, // 회피(비율);
		"hp value", // RANDOM_OPTION_VALUE_HP = 5, // hp 크기 변화(양);
		"mp value", // RANDOM_OPTION_VALUE_MP = 6, // mp 크기 변화(양);
		"sp value", // RANDOM_OPTION_VALUE_SP = 7, // sp 크기 변화(양);
		"hp Regen", // RANDOM_OPTION_RATE_RECOVERY_HP = 8, // hp 회복(비율);
		"mp Regen)", // RANDOM_OPTION_RATE_RECOVERY_MP = 9, // mp 회복(비율);
		"sp Regen", // RANDOM_OPTION_RATE_RECOVERY_SP = 10, // sp 회복(비율);
		"hp/mp/sp Regen", // RANDOM_OPTION_RATE_RECOVERY_HP_MP_SP = 11, // hp, mp, sp 회복(비율);
		"Grind attack", // RANDOM_OPTION_GRIND_DAMAGE = 12, // 공격력 연마;
		"Grind defense", // RANDOM_OPTION_GRIND_DEFENCE = 13, // 방어력 연마;
		"rate range", // RANDOM_OPTION_RATE_RANGE_ATTACK = 14, // 공격 영역(비율);
		"SP recovery", // RANDOM_OPTION_CONSUME_SP = 15, // sp 소모(양);
		"Resistence", // RANDOM_OPTION_VALUE_RESIST = 16, // 저항(양);
		"Move speed", // RANDOM_OPTION_RATE_SPEED_MOVE = 17, // 이동 속도(비율);
		"damage value", // RANDOM_OPTION_VALUE_DAMAGE = 18, // 공격력(양);
		"defense value", // RANDOM_OPTION_VALUE_DEFENCE = 19, // 방어력(양);
		"hitrate value", // RANDOM_OPTION_VALUE_HIT = 20, // 명중율(양);
		"avoid value", // RANDOM_OPTION_VALUE_AVOID = 21, // 회피율(양);
		"pow value", // RANDOM_OPTION_VALUE_POW = 22, // 힘(양);
		"str value", // RANDOM_OPTION_VALUE_STR = 23, // 체력(양);
		"str value", // RANDOM_OPTION_VALUE_SPI = 24, // 정신(양);
		"dex value", // RANDOM_OPTION_VALUE_DEX = 25,	 // 민첩(양);
		"stamina value", // RANDOM_OPTION_VALUE_STA = 26, // 근력(양);
		"Melle", // RANDOM_OPTION_MELEE = 27, // 격투치(양);
		"Missile", // RANDOM_OPTION_RANGE = 28, // 사격치(양);
		"Energy", // RANDOM_OPTION_MAGIC = 29, // 마력치(양);
		"hp value", // RANDOM_OPTION_VALUE_POTION_HP = 30, // 물약에 의한 hp 회복(양);
		"mp value", // RANDOM_OPTION_VALUE_POTION_MP = 31, // 물약에 의한 mp 회복(양);
		"sp value", // RANDOM_OPTION_VALUE_POTION_SP = 32, // 물약에 의한 sp 회복(양);
		"cp value", // RANDOM_OPTION_VALUE_KILL_CP = 33, // 몬스터 킬시 CP 변화(양);
		"1등급 스킬 지속시간",
		"2등급 스킬 지속시간",
		"3등급 스킬 지속시간",
		"4등급 스킬 지속시간",
