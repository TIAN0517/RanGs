	...
	, m_bUseFeaturesLoad(FALSE)
{
	...
	IMPLEMENT_FEATURES( ClubLockerMoneyDraw );
	IMPLEMENT_FEATURES( ClubLockerMoneySave );
	IMPLEMENT_FEATURES( ClubLockerItemGet );
	IMPLEMENT_FEATURES( ClubLockerItemSave );

	IMPLEMENT_FEATURES( LockerMoneyDraw );
	IMPLEMENT_FEATURES( LockerMoneySave );
	IMPLEMENT_FEATURES( LockerItemGet );
	IMPLEMENT_FEATURES( LockerItemSave );
	IMPLEMENT_FEATURES( TestServer );
	IMPLEMENT_FEATURES( TutorialMode );
}
