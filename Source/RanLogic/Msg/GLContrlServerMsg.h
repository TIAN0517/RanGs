...
#pragma pack(1)
	...
	//PK Notification
	struct SNET_PK_RANK_HISTORY_UPDATE : public NET_MSG_GENERIC
	{
		...
		{
			dwSize = sizeof(*this);
			nType = NET_MSG_PK_RANK_HISTORY_UPDATE;
			MIN_STATIC_ASSERT(sizeof(SNET_PK_RANK_HISTORY_UPDATE)<=NET_DATA_BUFSIZE);
		}        
	};
