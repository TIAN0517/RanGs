...
namespace private_market
{
    ...
    enum eSellType
    {
		...
		eSellType_ConsignmentSale_RanPointBet, // 란포인트 거래
		eSellType_ConsignmentSale_GoldBet,     // 골드 거래
