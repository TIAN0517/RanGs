...
public:
	enum EMUSE_FEATURES
	{
		...
		EMUSE_FEATURE_CLUB_LOCKER_MONEY_DRAW,
		EMUSE_FEATURE_CLUB_LOCKER_MONEY_SAVE,
		EMUSE_FEATURE_CLUB_LOCKER_ITEM_GET,
		EMUSE_FEATURE_CLUB_LOCKER_ITEM_SAVE,

		EMUSE_FEATURE_LOCKER_MONEY_DRAW,
		EMUSE_FEATURE_LOCKER_MONEY_SAVE,
		EMUSE_FEATURE_LOCKER_ITEM_GET,
		EMUSE_FEATURE_LOCKER_ITEM_SAVE,
		EMUSE_FEATURE_TEST_SERVER,
		EMUSE_FEATURE_TUTORIAL_MODE,
		// 사이즈;
		EMUSE_FEATURE_SIZE,
	};
...
public:
	...
	DECLARE_FEATURES( ClubLockerMoneyDraw );
	DECLARE_FEATURES( ClubLockerMoneySave );

	DECLARE_FEATURES( ClubLockerItemGet );
	DECLARE_FEATURES( ClubLockerItemSave );

	DECLARE_FEATURES( LockerMoneyDraw );
	DECLARE_FEATURES( LockerMoneySave );

	DECLARE_FEATURES( LockerItemGet );
	DECLARE_FEATURES( LockerItemSave );
	DECLARE_FEATURES( TestServer );
	DECLARE_FEATURES( TutorialMode );
