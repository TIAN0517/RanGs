...
enum EMCHARLOCK_TYPE
{
	EMCHARLOCK_TYPE_INVENTORY = 0,
	EMCHARLOCK_TYPE_LOCKER = 1,
};
...
//	NET_MSG_PING_ANSWER		    = 151, //! 서버에서 ping 을 응답한다.
	...
	NET_MSG_REGISTER,
	NET_MSG_REGISTER_FB,
    NET_MSG_REGISTER_FEEDBACK_DATA2, //! 
	NET_MSG_REGISTER_FB_SUB_OK_FIELD, //! 로그인성공결과를 필드서버로 전송해서 세팅하게 한다.

	CHINA_NET_MSG_EMAIL,
	CHINA_NET_MSG_EMAIL_FB,
	CHINA_NET_MSG_PIN,
	CHINA_NET_MSG_PIN_FB,
	CHINA_NET_MSG_TOPUP,
	CHINA_NET_MSG_TOPUP_FB,
	CHINA_NET_MSG_TOPUP_GEN,
	CHINA_NET_MSG_TOPUP_GEN_FB,
	CHINA_NET_MSG_GT2VP,
	CHINA_NET_MSG_GT2VP_FB,
	CHINA_NET_MSG_PASS,
	CHINA_NET_MSG_PASS_FB,
	CHINA_NET_MSG_RESETPASS,
	CHINA_NET_MSG_RESETPASS_FB,
	CHINA_NET_MSG_RESETPASS2,
	CHINA_NET_MSG_RESETPASS2_FB,
	CHINA_NET_MSG_RESETPIN,
	CHINA_NET_MSG_RESETPIN_FB,
	CHINA_NET_MSG_PP2VP,
	CHINA_NET_MSG_PP2VP_FB,
...
//	NET_MSG_REQ_ATTEND_REWARD_FLD,	//! 출석 체크 이벤트 아이템 지급 ( 필드용 )	
	...
	NET_MSG_GCTRL_REQ_STATSUPCMD,
	NET_MSG_GCTRL_REQ_STATSUPCMD_FB,

	NET_MSG_REQ_TUTORIAL_COMPLETE,
	NET_MSG_REQ_TUTORIAL_COMPLETE_MOVE,
	NET_MSG_REQ_TUTORIAL_ACK,

	NET_MSG_REQ_CHAR_LOCK_CF,
	NET_MSG_REQ_CHAR_LOCK_FB,

	NET_MSG_GCTRL_GET_RANKINGS_FROMDB,
	NET_MSG_GCTRL_GET_RANKINGS_FROMDB_FB,

	//PK Notification
	NET_MSG_PK_RANK_HISTORY_UPDATE,
	//================================== 기준점 ==================================
	// !!!!!!!!!! 주의 !!!!!!!!!!
