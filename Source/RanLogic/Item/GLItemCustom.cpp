...
//	코스툼.
bool SITEMCUSTOM::IsWing() const
{
    return CheckItemFlag(ITEM_TYPE_WING, CHECKFLAGOP_NORMAL);
}

bool SITEMCUSTOM::IsRestirctCostume() const
{
	return CheckItemFlag(ITEM_RESTRICT_COSTUME, CHECKFLAGOP_NORMAL);
}
