...
void COuterInterface::ToChinaAreaPage ( UIGUID cID )
{
	...
	if( cID != SELECT_CHINA_AREA_PAGE )
	{
		...
		UiHideGroup ( CHANGEPIN_PAGE, bMakeMsg );
		UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
		UiHideGroup ( PREMIUMPOINTCVT_PAGE, bMakeMsg );
		UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
		UiHideGroup ( RESETPASS_PAGE, bMakeMsg );
		UiHideGroup ( RESETPASS_PAGE2, bMakeMsg );
		UiHideGroup ( RESETPIN_PAGE, bMakeMsg );
		UiHideGroup ( CHANGEEMAIL_PAGE, bMakeMsg );
		UiHideGroup ( SELECT_CHARACTER_USERPANEL, bMakeMsg );
...
void COuterInterface::ToSelectServerPage ( UIGUID cID )
{
	...
	UiHideGroup ( RESETPIN_PAGE, bMakeMsg );
	UiHideGroup ( CHANGEEMAIL_PAGE, bMakeMsg );
	UiHideGroup ( CREATE_CHARACTER_PAGE, bMakeMsg );
	...
	UiHideGroup ( SELECT_CHARACTER_USERPANEL, bMakeMsg );
	UiHideGroup ( LOCK_SELECT_CHARACTER_PREVIEW_PAGE, bMakeMsg );
	UiHideGroup ( SELECT_COUNTRY_WINDOW, bMakeMsg );
	UiHideGroup ( SELECT_CLUB_WINDOW, bMakeMsg );
...
void	COuterInterface::ToRegisterPage ( UIGUID cID )
{
	...
	if ( m_pRegisterPage )
	{
		UiShowGroupFocus( REGISTER_PAGE, bMakeMsg );
	}
}
...
void COuterInterface::ToSelectCharacterPage( UIGUID cID )
{
	...
	UiHideGroup ( REGISTER_PAGE, bMakeMsg );
	UiHideGroup ( CHANGEPIN_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
	UiHideGroup ( PREMIUMPOINTCVT_PAGE, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
...
//#endif
	...
	if ( m_pSelectServerPage )
	{
		...
		UiShowGroupFocus( SELECT_CHARACTER_USERPANEL, bMakeMsg );
...
void 	COuterInterface::ToTOPUPPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( TOPUP_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPIN_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
	UiHideGroup ( PREMIUMPOINTCVT_PAGE, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
...
void 	COuterInterface::ToGTCVTPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( GAMETIMECVT_PAGE, bMakeMsg );
	...
	UiHideGroup ( RESETPASS_PAGE2, bMakeMsg );
	UiHideGroup ( RESETPIN_PAGE, bMakeMsg );
	UiHideGroup ( TOPUP_PAGE, bMakeMsg );
	UiHideGroup ( PREMIUMPOINTCVT_PAGE, bMakeMsg );
}
...
void 	COuterInterface::ToPPCVTPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( PREMIUMPOINTCVT_PAGE, bMakeMsg );
...
void 	COuterInterface::ToCPPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( CHANGEPASS_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
	UiHideGroup ( CHANGEPIN_PAGE, bMakeMsg );
...
void 	COuterInterface::ToCPNPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( CHANGEPIN_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
...
void 	COuterInterface::ToRPNPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( RESETPIN_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
...
void 	COuterInterface::ToRPSPage( UIGUID cID )
{
	...
	UiShowGroupFocus ( RESETPASS_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
...
void 	COuterInterface::ToRPSPage2( UIGUID cID )
{
	...
	UiShowGroupFocus ( RESETPASS_PAGE2, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPASS_PAGE, bMakeMsg );
	UiHideGroup ( GAMETIMECVT_PAGE, bMakeMsg );
...
{
	bool bMakeMsg = true;
	UiShowGroupFocus ( CHANGEEMAIL_PAGE, bMakeMsg );
	if ( cID == SELECT_CHARACTER_USERPANEL )
	{}else UiHideGroup ( cID, bMakeMsg );
	UiHideGroup ( CHANGEPIN_PAGE, bMakeMsg );
	UiHideGroup ( RESETPASS_PAGE, bMakeMsg );
