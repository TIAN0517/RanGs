...
public:
    ...
    virtual void EndClubBattleTime() = 0;   //�������� ������ġ �Լ� ����
...
public:
	...
	virtual CUIEditBox *GetEditBox()  = 0;
	virtual CUIEditBoxMan* GetEditBoxMan()  = 0;
	virtual BOOL Is2ndPWDModal()  = 0;
	virtual int CheckNew2ndPassString()  = 0;
	virtual UI::String GetNew2ndPassString()  = 0;

	virtual void SetInputText ( std::string strText ) = 0;
	virtual void SetReInputText ( std::string strText ) = 0;
};
...
public:
    virtual void CreateUIWindowAndRegisterOwnership() = 0;
    virtual void Show ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor ) = 0;
	virtual void ShowPublic ( const std::string& strText, const D3DCOLOR& TextColor ) = 0;
...
public:
	...
	virtual void SetBattlePointText ( __int64 nPoint ) = 0;
...
public:
	...
	virtual void SetItemPreviousInformation ( const SITEMCUSTOM& sItemCustom ) = 0;
	virtual void SetItemRebuildSetCheckBox(const SITEMCUSTOM& sItemCustom, const ITEM_RANDOMOP_UTILL::FixOption& fixOption, bool bPrevious=false) = 0;
};
...
//	CCharacterWindow*			m_pCharacterWindow;
	...
	//��ʸ�Ʈ UI
	CTournamentEntranceConfirm*	m_pEntranceConfirm;			// ���� ���
	TournamentObserveWindow*	m_pTournamentObserveWindow;	// ��ʸ�Ʈ ������ UI
	CTournamentMulty*			m_pTournamentMulty;			// Score ���� UI
	TournamentMiniExpeditionWindow* m_pBigGroupWindowRight;	// �������� ĳ���� ����
	TournamentMiniExpeditionWindow* m_pBigGroupWindowLeft;	// ������ ĳ���� ����
	CTournamentExpeditionInfoGroup* m_pMiniGroupWindowRight; // �������� ĳ���� ����
	CTournamentExpeditionInfoGroup* m_pMiniGroupWindowLeft; // �������� ĳ���� ����
	
	CTournamentIndicator* m_pTournamentIndicator;						// ��ʸ�Ʈ �̵�������.
...
public:
	...
	virtual void UiSetGroupLock(UIGUID ControlID, bool bLock = true); // CUIMan::SetGorupLock() �Լ� �ּ� ����.
...
public:	
	...
	virtual void SetItemPreviousInformation ( const SITEMCUSTOM& sItemCustom );
	virtual void SetItemRebuildSetCheckBox(const SITEMCUSTOM& sItemCustom, const ITEM_RANDOMOP_UTILL::FixOption& fixOption, bool bPrevious=false);
    virtual void CheckItemRebuildWindowClose(const bool bUseStamp, const ITEM_RANDOMOP_UTILL::FixOption& fixOption);
	...
	virtual void OpenItemGarbageWindow();	// ������
	...
	virtual void	OPEN_TAXI_WINDOW( WORD wPosX, WORD wPosY );			// �ý� ī��
	...
	//		ä��â ��ũ ����	
	virtual void ChatToLink(const SLINK_DATA_BASIC& sLinkDataBasic, const SITEMCUSTOM *pItemCustom = NULL /*GroupChat������ SITEMCUSTOM�� ����Ѵ�*/);	
	...
	//	��ũ ������ ����Ѵ�. 
	virtual int		AddLinkDataToList_Client ( const SLINK_DATA_BASIC& sLinkDataBasic );		//	Ŭ���̾�Ʈ ������ ���
...
public:
	...
	virtual void	BONUS_TIME_EVENT_START( bool bCharging ); // �̺�Ʈ ����
	virtual void	BONUS_TIME_EVENT_END(); // �̺�Ʈ ����
	virtual void	BONUS_TIME_BUSTER_START(); // ����ġ ����
	virtual void	BONUS_TIME_BUSTER_END(); // ����ġ ����
...
public:
    ...
    //! ProgressDisplay
    virtual void ProgressDisplayShow ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor = NS_UITEXTUTIL::WHITE );
	virtual void ProgressDisplayShowPulblic ( const std::string& strText, const D3DCOLOR& TextColor = NS_UITEXTUTIL::WHITE );
	...
	virtual void PointShopSetBattlePoint ( __int64 nCurPoint );
	...
	void ModalItemRebuildPrevQuestion(DWORD dwMsg);
	...
	void ModalInvenLockChangePassword(DWORD dwMsg);
	void ModalInvenLockResetPassword(DWORD dwMsg);
	void ModalInvenLockUnlock(DWORD dwMsg);

	void ModalStorageLockChangePassword (DWORD dwMsg);
	void ModalStorageLockUnlock (DWORD dwMsg);
	void ModalStorageLockResetPassword (DWORD dwMsg);
