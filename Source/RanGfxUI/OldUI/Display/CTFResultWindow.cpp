...
void CCTFResultWindow::CreateSubControl ()
{
	//! 정렬버튼
	{
		...
		m_pSortButton_CLUB->CreateSub( this, "CTF_RESULT_SORTBUTTON_CLUB", UI_FLAG_DEFAULT, CTF_RESULT_SORTBUTTON_CLUB);
...
void CCTFResultWindow::TranslateUIMessage ( UIGUID ControlID, DWORD dwMsg )
{
	...
	case CTF_RESULT_SORTBUTTON_CLUB:
		{
