...
// ----------------------------------------------------------------------------
CNameDisplay::CNameDisplay(GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice)
...
void CNameDisplay::SET_INFO ( const CROWREN &sINFO, const TCHAR *szOwnerName )	
{ 
    m_sDISP_INFO = sINFO;
