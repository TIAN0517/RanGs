...
void CProgressDisplay::Show ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor )
{
    INFOCAPS sInfo(emType, strText, TextColor);
...
void CProgressDisplay::ShowPublic( const std::string& strText, const D3DCOLOR& TextColor )
{
	Show( UI::EMPROGRESSDISPLAY_TYPE_PUBLIC, strText, TextColor );
}
...
void MyProgressDisplay::Show ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor )
{
	CProgressDisplay::Show( emType, strText, TextColor );
}

void MyProgressDisplay::ShowPublic( const std::string& strText, const D3DCOLOR& TextColor )
{
	CProgressDisplay::ShowPublic( strText, TextColor );
}
