...
public:
    void                        Show ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor );
	void                        ShowPublic ( const std::string& strText, const D3DCOLOR& TextColor );
    void                        Begin ();
    void                        Hide ();
    void                        Update ();
...
private:
    struct INFOCAPS
    {
        INFOCAPS(UI::EMPROGRESSDISPLAY_TYPE _emType, std::string _strText, D3DCOLOR _TextColor)
            : emType(_emType)
            , strText(_strText)
            , IsBegin(false)
...
public:
    ...
    virtual void       Show ( const UI::EMPROGRESSDISPLAY_TYPE emType, const std::string& strText, const D3DCOLOR& TextColor );
	virtual void       ShowPublic (const std::string& strText, const D3DCOLOR& TextColor );
    virtual void       Update ();
