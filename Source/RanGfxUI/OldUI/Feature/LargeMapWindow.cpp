...
CLargeMapWindow::CLargeMapWindow(GLGaeaClient* pGaeaClient, CInnerInterface* pInterface, EngineDeviceMan* pEngineDevice)
...
void CLargeMapWindow::SetMapLevelFile(const GLLevelFileClient& levFile, const CString& strMapName )
{
