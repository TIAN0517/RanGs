...
const DWORD PartyWindowRenewal::GetPartyID(void) const
{
	return m_dwPartyID;
}
const DWORD PartyWindowRenewal::GetHashKey(void) const
{
	return m_dwHashKey;
}
const DWORD PartyWindowRenewal::GetMasterID(void) const
{
	return m_dwMasterID;
}
const DWORD PartyWindowRenewal::GetTimeKey(void) const
{
	return m_dwTimeKey;
}

void PartyWindowRenewal::SetPartyInfo(const DWORD dwPartyID, const DWORD dwHashKey, const DWORD dwMasterID, const DWORD dwTimeKey)
{
...
const DWORD MyPartyWindowRenewal::GetPartyID(void) const
{
	return PartyWindowRenewal::GetPartyID();
}
const DWORD MyPartyWindowRenewal::GetHashKey(void) const
{
	return PartyWindowRenewal::GetHashKey();
}
const DWORD MyPartyWindowRenewal::GetMasterID(void) const
{
	return PartyWindowRenewal::GetMasterID();
}
const DWORD MyPartyWindowRenewal::GetTimeKey(void) const
{
	return PartyWindowRenewal::GetTimeKey();
}

void MyPartyWindowRenewal::SetPartyInfo(const DWORD dwPartyID, const DWORD dwHashKey, const DWORD dwMasterID, const DWORD dwTimeKey)
{
	PartyWindowRenewal::SetPartyInfo( dwPartyID, dwHashKey, dwMasterID, dwTimeKey );
}
