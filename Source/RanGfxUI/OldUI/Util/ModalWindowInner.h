...
public:
	...
	virtual CUIEditBox *GetEditBox();
	virtual CUIEditBoxMan* GetEditBoxMan();
	virtual BOOL Is2ndPWDModal();
	virtual int CheckNew2ndPassString();
	virtual UI::String GetNew2ndPassString();

	virtual void SetInputText ( std::string strText );
	virtual void SetReInputText ( std::string strText );
};
