...
CUIEditBox * MyModalWindow::GetEditBox()
{
	return CModalWindowInner::GetEditBox();
}
CUIEditBoxMan* MyModalWindow::GetEditBoxMan()
{
	return CModalWindowInner::GetEditBoxMan();
}
BOOL MyModalWindow::Is2ndPWDModal()
{
	return CModalWindowInner::Is2ndPWDModal();
}
int MyModalWindow::CheckNew2ndPassString()
{
	return CModalWindowInner::CheckNew2ndPassString();
}
UI::String MyModalWindow::GetNew2ndPassString()
{
	return CModalWindowInner::GetNew2ndPassString();
}

void MyModalWindow::SetInputText ( std::string strText )
{
	CModalWindowInner::SetInputText( strText );
}

void MyModalWindow::SetReInputText ( std::string strText )
{
	CModalWindowInner::SetReInputText( strText );
}