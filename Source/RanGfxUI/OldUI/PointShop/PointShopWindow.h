...
private:
	...
	CBasicTextBox* m_pBattlePointText;
	CBasicTextBox* m_pCurBattlePointText;
...
public:
	...
	void SetBattlePointText ( __int64 nPoint );
...
private:
    ...
    void AddCartList( SNATIVEID ItemID, __int64 Price, WORD wCurrency );
    void ReLoadCartList();
    void ResetCartList();
...
public:
	...
	virtual void SetBattlePointText ( __int64 nPoint );
