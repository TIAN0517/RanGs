...
#include "OldUI/Interface/RegisterPage.h"

//userpanel
#include "OldUI/Interface/IngameUserPanel/ChangePinPage.h"
#include "OldUI/Interface/IngameUserPanel/ChangePasswordPage.h"
#include "OldUI/Interface/IngameUserPanel/ResetPasswordPage.h"
#include "OldUI/Interface/IngameUserPanel/ResetPasswordPage2.h"
#include "OldUI/Interface/IngameUserPanel/ResetPinPage.h"
#include "OldUI/Interface/IngameUserPanel/ChangeEmailPage.h"
#include "OldUI/Interface/IngameUserPanel/TopUpPage.h"
#include "OldUI/Interface/IngameUserPanel/GameTimeCVTPage.h"
#include "OldUI/Interface/IngameUserPanel/PremiumPointCVTPage.h"
#include "OldUI/Interface/IngameUserPanel/SelectCharacterUserPanel.h"
...
{
	ResetControl();
	SetLobyStage(m_pGaeaClient->GetGlobalStage()->GetLobyStage());
}
...
//#endif
	...
	{
		m_pRegisterPage = new CRegisterPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl( m_pRegisterPage );
		UiShowGroupFocus ( REGISTER_PAGE );
	}

	//userpanel
	{
		m_pChangePinPage = new CChangePinPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pChangePinPage );
		UiShowGroupFocus ( CHANGEPIN_PAGE );

	}

	{
		m_pChangePasswordPage = new CChangePasswordPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pChangePasswordPage );
		UiShowGroupFocus ( CHANGEPASS_PAGE );

	}

	{
		m_pResetPasswordPage = new CResetPasswordPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pResetPasswordPage );
		UiShowGroupFocus ( RESETPASS_PAGE );

	}
	
	{
		m_pResetPasswordPage2 = new CResetPasswordPage2(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pResetPasswordPage2 );
		UiShowGroupFocus ( RESETPASS_PAGE2 );

	}
	
	{
		m_pResetPinPage = new CResetPinPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pResetPinPage );
		UiShowGroupFocus ( RESETPIN_PAGE );

	}

	{
		m_pChangeEmailPage = new CChangeEmailPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pChangeEmailPage );
		UiShowGroupFocus ( CHANGEEMAIL_PAGE );

	}

	{
		m_pTopUpPage = new CTopUpPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pTopUpPage );
		UiShowGroupFocus ( TOPUP_PAGE );

	}

	{
		m_pGameTimeCVTPage = new CGameTimeCVTPage(m_pGaeaClient, this, m_pEngineDevice);
		...
		UiRegisterControl ( m_pGameTimeCVTPage );
		UiShowGroupFocus ( GAMETIMECVT_PAGE );
...

	{
		...
		//HideGroup ( PREMIUMPOINTCVT_PAGE );
	}
	//userpanel end
...
*/
	...
	//userpanel
	{
		...
		m_pSelectCharacterUserPanel = new CSelectCharacterUserPanel(m_pGaeaClient, this, m_pEngineDevice);
		m_pSelectCharacterUserPanel->Create ( SELECT_CHARACTER_USERPANEL, "SELECT_CHARACTER_USERPANEL", UI_FLAG_DEFAULT );
		m_pSelectCharacterUserPanel->CreateSubControl ();
		m_pSelectCharacterUserPanel->SetChangeSize( TRUE );
		UiRegisterControl ( m_pSelectCharacterUserPanel );
		UiShowGroupFocus ( SELECT_CHARACTER_USERPANEL );
		UiHideGroup ( SELECT_CHARACTER_USERPANEL );
	}
...
*/
			...
			if( m_pSelectCharacterUserPanel && m_pSelectCharacterUserPanel->IsVisible() )
			{
