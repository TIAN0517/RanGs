...
void XmlConverter::ClearLuaDefaultString()
{
	...
	ClearString(COMMENT::ITEM_RANDOM_OPT,		RandomOption::RANDOM_OPTION_NSIZE);
	...
	ClearString(COMMENT::CHARCLASS,					GLCI_NUM_TRICKER);
	ClearString(COMMENT::CHARCOMMENT,				GLCI_NUM_TRICKER);
	...
	ClearString(COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE);
	ClearString(COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE);
	ClearString(COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE);
	ClearString(COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE);
	ClearString(COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE);
...
bool XmlConverter::RanTextConvertToXml_CommentLua_OnlyText(const char* szFile, const char* szSave, const char* szNational, bool bSave)
{
	...
	language::EMPROVIDE_LANGFLAG emProvideLangflag = language::StringToProvidelang(const_cast<char*>(szNational));
...
// 		return false;
	...
	_Lua_2_Composition("ITEM_RANDOM_OPT",				COMMENT::ITEM_RANDOM_OPT,		RandomOption::RANDOM_OPTION_NSIZE, szNational);
	...
	_Lua_2_Composition("CHARCLASS",						COMMENT::CHARCLASS,					GLCI_NUM_TRICKER, szNational);
	_Lua_2_Composition("CHARCOMMENT",					COMMENT::CHARCOMMENT,				GLCI_NUM_TRICKER, szNational);
	...
	_Lua_2_Composition("ITEMLEVEL",						COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE, szNational);
	_Lua_2_Composition("ITEMLEVEL",						COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE, szNational);
	_Lua_2_Composition("ITEMLEVEL",						COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE, szNational);
	_Lua_2_Composition("ITEMLEVEL",						COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE, szNational);
	_Lua_2_Composition("ITEMLEVEL",						COMMENT::ITEMLEVEL,					EMITEM_LEVEL_NSIZE, szNational);
	...
	_Lua_2_Composition( _T( "ANI_MAINTYPE" ),			COMMENT::ANI_MAINTYPE+1, AN_TYPE_SIZE , szNational);
									  ...
									  , const char* szNation )
{
	...
	language::EMPROVIDE_LANGFLAG emProvideLangflag = language::StringToProvidelang(const_cast<char*>(szNation));
	const int nLang = (int)language::ProvidelangToLangflag(emProvideLangflag);
