...
BOOL CSkinObjPage::LoadSkinObject( const char *pszFileName )
{
	...
	{
		MessageBox ( "An error occurred while reading the skin object file." );
		return FALSE;
	}
	return TRUE;
}
...
void CSkinObjPage::OnBnClickedButtonMakeobj()
{
	...
	{
		MessageBox ( "No skin or bone files were specified." );
		return;
	}
	...
	{
		MessageBox ( "Failed to create skins and bones." );
	}
}
