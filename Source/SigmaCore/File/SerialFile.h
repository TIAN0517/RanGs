...
public:
    SerialFile();
    SerialFile(FOPENTYPE _Type, const char *_szFileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE);
    virtual ~SerialFile();
...
public:
    ...
    virtual BOOL OpenFile(const FOPENTYPE _Type, const char* _szFileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE );
