...
SerialFile::SerialFile(FOPENTYPE _Type, const char *_szFileName, EMBYTECRYPT emCrypt /*= EMBYTECRYPT_NONE*/)
    : BaseStream()
    , m_FileStream(NULL)
{
...
BOOL SerialFile::OpenFile ( const FOPENTYPE _Type, const char *_szFileName, EMBYTECRYPT emCrypt )
{
	MIN_ASSERT(_szFileName);
