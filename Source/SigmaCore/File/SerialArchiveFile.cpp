...
BOOL SerialArchiveFile::OpenFile( const FOPENTYPE _Type, const char* _szFileName, EMBYTECRYPT emCrypt /*= EMBYTECRYPT_NONE*/ )
{
    ...
    if (_Type == FOT_READ)
    {
        return SerialFile::OpenFile(_Type, _szFileName, emCrypt);
    }
