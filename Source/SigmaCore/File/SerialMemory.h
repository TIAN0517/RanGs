...
public:
    SerialMemory();
    SerialMemory(const char *_szZipFileName, const char *_szFileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE);
...
public:
    ...
    BOOL OpenFile(const std::string& ZipFileName, const std::string& FileName, EMBYTECRYPT emCrypt = EMBYTECRYPT_NONE, BOOL bPack = FALSE);
