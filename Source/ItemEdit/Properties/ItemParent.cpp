...
void CItemParent::UpdateItems ()
{
	...
	SetWin_Check( this, IDC_CHECK_RESTRICT_COSTUME, m_pDummyItem->sBasicOp.dwFlags&ITEM_RESTRICT_COSTUME );
    ...
    SetWin_Check( this, IDC_CHECK_BOX_WING, m_pDummyItem->sBasicOp.dwFlags&ITEM_TYPE_WING );  // 포장지로 포장 가능 여부;
...
BOOL CItemParent::InverseUpdateItems ()
{
	...
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_RESTRICT_COSTUME ), m_pDummyItem->sBasicOp.dwFlags, ITEM_RESTRICT_COSTUME );
    ...
    SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_BOX_WING ), m_pDummyItem->sBasicOp.dwFlags, ITEM_TYPE_WING );  // 포장지로 포장 가능 여부;
