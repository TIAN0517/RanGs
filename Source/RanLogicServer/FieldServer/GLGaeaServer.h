...
// 	BOOL MsgPartyChangeOption(DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg);	 	
	...
	BOOL MsgChaTutorialComplete( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
	BOOL MsgChaTutorialCompleteMove( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
	...
	BOOL MsgReqAddStats ( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
private:
...
public:
	...
	BOOL MsgReqCharacterLock( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
	BOOL MsgCharacterLockFB( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
	BOOL MsgReqRankingInfo ( DWORD dwClientID, DWORD dwGaeaID, NET_MSG_GENERIC* nmg );
};
