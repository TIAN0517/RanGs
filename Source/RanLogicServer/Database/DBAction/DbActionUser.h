...
class CAgentUserRegister : public db::DbAction
{
public:
	CAgentUserRegister(
		const TCHAR* szUserID, // ID 
...
//userpanel
class CAgentUserResetPassword : public db::DbAction
{
public:
...
class CAgentUserResetPassword2 : public db::DbAction
{
public:
...
class CAgentUserResetPin : public db::DbAction
{
public:
	CAgentUserResetPin(
		const TCHAR* szUserID, // ID 
...
class CAgentUserChangePassword : public db::DbAction
{
public:
...
class CAgentUserChangePin : public db::DbAction
{
public:
	CAgentUserChangePin(
		const TCHAR* szUserID, // ID 
...
class CAgentUserChangeEmail : public db::DbAction
{
public:
...
class CAgentUserTopUp : public db::DbAction
{
public:
	CAgentUserTopUp(
		const TCHAR* szUserID, // ID 
...
class CAgentUserGameTimeCVT : public db::DbAction
{
public:
...
class CAgentUserPremiumPointCVT : public db::DbAction
{
public:
