...
public:
	...
	virtual int GetRankings( std::vector<RANKING> &v , bool bPK = false , bool bLevel = false , bool bRich = false ) = 0;
    ...
    virtual int GetChaPoint(int ChaDbNum, __int64& PointRefundable, __int64& PointNotRefundable, __int64& PointBattle) = 0;
    virtual int SetChaPoint(int ChaDbNum, const __int64& PointRefundable, const __int64& PointNotRefundable, const __int64& PointBattle) = 0;
...
public:
	...
	virtual int ChaLockPassword(DWORD ChaDbNum, const char* ReqPassword, EMCHARLOCK_TYPE emLockType, PGLCHAR pCharacter, bool bUnlock = false)  = 0;
	virtual int ChaLockChangeResetPassword(DWORD ChaDbNum, const char* ReqPassword, const char* ReqPIN, EMCHARLOCK_TYPE emLockType, PGLCHAR pCharacter, bool bReset = false) = 0;
};
