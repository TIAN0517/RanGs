...
void GLAgentServer::initPacketFunc()
{
	...
	m_MsgFunc[NET_MSG_GCTRL_PMARKET_OPEN].Msgfunc = &GLAgentServer::MsgPrivateMarketSearchOpenFA;
	m_MsgFunc[NET_MSG_GCTRL_PMARKET_CLOSE].Msgfunc = &GLAgentServer::MsgPrivateMarketSearchCloseFA;
	
}

BOOL GLAgentServer::MsgPrivateMarketSearchOpenFA( NET_MSG_GENERIC* nmg, DWORD ClientSlot, DWORD dwGaeaID )
{
	...
	if ( pChar )
	{
		...
		sc::writeLogInfo( "MsgPrivateMarketSearchOpenFA  MsgPMarketOpen" );
	}

	return TRUE;
}

BOOL GLAgentServer::MsgPrivateMarketSearchCloseFA( NET_MSG_GENERIC* nmg, DWORD ClientSlot, DWORD dwGaeaID )
{
	if ( dwGaeaID != GAEAID_NULL )
		return FALSE;
	...
	if ( pChar )
	{
		...
		sc::writeLogInfo( "MsgPrivateMarketSearchCloseFA  MsgPMarketClose" );
	}
