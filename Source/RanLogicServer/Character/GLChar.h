...
public:
    ...
    void PointShopPointDbSave(__int64 PointRefundable, __int64 PointNotRefundable, __int64 PointBattle, int nType = 0, __int64 OriPointRefundable = 0, __int64 OriPointNotRefundable = 0, __int64 OriPointBattle = 0, __int64 SubValue = 0 );
    ...
    bool PointShopPointAdd(__int64 PointRefundable, __int64 PointNotRefundable, __int64 PointBattle, pointshop::EM_POINT_CHANGE_TYPE Type);
	...
	void PointShopBattlePointSub( const SNATIVEID& BuyItem, __int64 ItemPrice, int nTraceType = 0 );
	void PointShopBattlePointSub( __int64 point, pointshop::EM_POINT_CHANGE_TYPE ePointChangeType, int nTraceType = 0 );
	void PointShopBattlePointSub( __int64 point, const SNATIVEID& Item, pointshop::EM_POINT_CHANGE_TYPE ePointChangeType, int nTraceType = 0 );
	CHARACTER_POINT PointShopBattlePointSub( __int64 point, int nTraceType = 0 ); 
private:
...
public:
    ...
    void PointShopBuyItem( const SNATIVEID& BuyItem, __int64 ItemPrice, const SITEMCUSTOM& ItemCustom, const WORD wCurrency );
...
public:
	...
	void SENDRANKINGSINFO( bool bPK = false, bool bLevel = false , bool bRich = false, bool bReset = true );
