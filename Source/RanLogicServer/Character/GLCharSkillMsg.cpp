        ...
        case EMSKILL_LEARN_OK:
            ...
            if ( pCHARSKILL == NULL ) 
            {
                ...
                else            // 돈으로도 스킬을 배울 수 있다.
                {
					...
					LONGLONG llUseMoney = GLogicData::GetInstance().GetRnSkillUseMoney( sSkillID );
            ...
            else // 스킬 레벨업
            {
				...
				// 요구 돈 체크;
				LONGLONG llReqMoney = GLogicData::GetInstance().GetRnSkillUseMoney( pSkill->GetId() );
