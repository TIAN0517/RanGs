...
//add statsup cmd
HRESULT GLChar::MsgReqStatsUpCmd ( NET_MSG_GENERIC* nmg )
{
	GLMSG::SNETPC_REQ_STATSUPCMD *pNetMsg = static_cast<GLMSG::SNETPC_REQ_STATSUPCMD*>(nmg);
	...
	//	처리 결과 응답.
	GLMSG::SNETPC_REQ_STATSUPCMD_FB NetMsgFB;
	NetMsgFB.emStats = pNetMsg->emStats;
	NetMsgFB.dwValue = pNetMsg->dwValue;
	NetMsgFB.wStatsPoint = m_wStatsPoint;
	SendToClient(&NetMsgFB);
